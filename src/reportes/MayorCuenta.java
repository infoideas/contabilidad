 ...
 * @author Propietario
 */
public class MayorCuenta extends javax.swing.JFrame {
    public boolean mod;
        ...
        DocumentListener documentListener = new DocumentListener() {
            ...
            private void printIt(DocumentEvent documentEvent) {
                ...
                try {
                    ...
                    Logger.getLogger(MayorCuenta.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private ArrayList buscaListaMovimientos(Cuenta cuenta,Date fec_ini,Date fec_fin) {
...
//                + "order by a.fecMov");
        Query q=session.createQuery("Select a.id,a.fecMov,c,a.idUsuario,a.descripcion,b.dc,b.valor "
                + "from Asiento a "
                + "JOIN a.asientoDets b "
                + "LEFT JOIN a.plantilla c "
                + "where b.cuenta= :cuentaSel "
                + "and a.ejercicio = :ejercicioSel "
                + "and a.fecMov >= :fec_ini and a.fecMov <= :fec_fin "
                + "order by a.fecMov");
        ...
        for (Object[] datos : resultList) {
            ...
            Plantilla plantilla=(Plantilla) datos[2];
            int li_plantilla=0;
            String ls_nombre_plantilla="";
            if (plantilla != null){
                li_plantilla=plantilla.getId().intValue();
                ls_nombre_plantilla=plantilla.getNombre();
                item.setNumPlantilla(li_plantilla);
                item.setNombrePlantilla(ls_nombre_plantilla);
            }
            else{
                item.setNumPlantilla(li_plantilla);
                item.setNombrePlantilla(ls_nombre_plantilla);
            ...
            int li_usuario=(int) datos[3];
            usuario=bean.obtenerUsuario(li_usuario);
            item.setUsuario(usuario.getNombreCompletoUsuario());
            item.setDescripcion((String) datos[4]);
            item.setDc(String.valueOf((char) datos[5]));            
            item.setValor((BigDecimal) datos[6]);
    ...
    private void buAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buAceptarActionPerformed
        ...
        ArrayList listaMovimientos =buscaListaMovimientos(cuenta, lda_fecha_desde, lda_fecha_hasta);

        //Genero reporte
        try {
            // TODO add your handling code here:
            ImpresionController imp= new ImpresionController();
            imp.generaReporteMayorCuenta(cuenta,listaMovimientos,ld_saldo_anterior,ls_intervalo);
        } catch (Exception ex) {
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
        PrincipalFrame.existeVentanaMayor=false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MayorCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MayorCuenta().setVisible(true);
            }
        });
    }
