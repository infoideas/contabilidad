 ...
 * @author rafael
 */
public class PlantillasFrame extends javax.swing.JFrame {
    ...
    public PlantillasFrame() {
        ...
        setTitle("Plantillas Ejercicio: " + PrincipalFrame.ejercicioSel );
        buscaLista();
    }
    ...
    public DefaultTableModel creaModelo(){
        ...
        listaData.getColumnModel().getColumn(1).setPreferredWidth(10);
        listaData.getColumnModel().getColumn(2).setPreferredWidth(500);
    ...
    public void consultaRegistro(){
        ...
        Plantilla p = (Plantilla) buscaRegistro(li_id);
        PlantillaDialog dialog = new PlantillaDialog(this, false);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (li_id > 0){
            int li_respuesta=JOptionPane.showOptionDialog(new JFrame(),"Está seguro de eliminar?","Eliminar plantilla",JOptionPane.YES_NO_OPTION,
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        PlantillaDialog dialog = new PlantillaDialog(this, true);
        dialog.setLocationRelativeTo(null);
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        // TODO add your handling code here:
        PrincipalFrame.existeVentanaPlantilla=false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlantillasFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlantillasFrame().setVisible(true);
            }
        });
    }
    ...
    try {
        ...
        Query q=session.createQuery("from Plantilla a where a.ejercicio = :ejercicioSel order by nombre");
    ...
    public boolean eliminaRegistro(Object o) {
       ...
       try{
           ...
           return true;
            ...
            session.getTransaction().rollback();
            JOptionPane.showMessageDialog(null, "Registro no pudo ser eliminado: " + e.getMessage(),"Error",JOptionPane.ERROR_MESSAGE);
            return false;
       }
       finally {
            session.close();
    ...
    public Object buscaRegistro(int id){
        ...
        try{
            ...
            Hibernate.initialize(p.getPlantillaParams());
            session.getTransaction().commit();
        }
        catch (HibernateException e){
            session.getTransaction().rollback();
