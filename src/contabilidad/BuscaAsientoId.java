 ...
 * @author rafael
 */
public class BuscaAsientoId extends javax.swing.JDialog {

    /**
     * Creates new form provinciasFrame
     */
    public BuscaAsientoId() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaAsientoId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscaAsientoId().setVisible(true);
            }
        });
    }
